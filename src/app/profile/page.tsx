...
const PLANS: Plan[] = [
  {
    ...
    rateLabel: "5.0% daily",
    ratePercent: "5%",
    rangeLabel: "$100 - $9,999",
    minDeposit: 100,
    maxDeposit: 9999,
    durationLabel: "3 days",
    features: ["5% daily returns", "3-day investment period", "Basic support", "Mobile app access"],
    ctaLabel: "Invest Now",
  },
  {
    id: "growth",
    ...
    features: ["8% daily returns", "7-day investment period", "Priority support", "Advanced analytics", "Withdrawal flexibility"],
    ctaLabel: "Invest Now",
  },
  {
    id: "premium",
    ...
    features: ["12% daily returns", "12-day investment period", "VIP support", "Personal account manager", "Custom investment strategies", "Early withdrawal options"],
    ctaLabel: "Invest Now",
  },
];
